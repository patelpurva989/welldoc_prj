/**
 * API Client - HARDCODED URL FOR RELIABILITY
 */
import axios from 'axios';

const API_BASE_URL = 'http://72.61.11.62:8660';
...
async function ensureAuthenticated() {
  ...
  try {
    const response = await axios.post('http://72.61.11.62:8660/api/v1/auth/login', {
      username: 'kevin',
      password: 'WellDoc2026!'
    }, {
      headers: { 'Content-Type': 'application/json' }
    });
